locals {
  mm_etl_workflow = {
    mm_ingest_delta_osm = {
      ...
      eb_rule_schedule_expression_description = "Trigger at 12:00 AM, on 1 and 15 of every month"
    ...
    mm_ingest_lrs_all = {
      create_eb                               = false
      eb_rule_schedule_expression             = "cron(0 0 ? * SUN *)"
      eb_rule_schedule_expression_description = "Trigger at 12:00 AM, on every Sunday, every month"
...
locals {
  sfn_service_versions = {
    MapImporter = {
      version = "2.0.17"
      image   = "558662781408.dkr.ecr.ap-southeast-2.amazonaws.com/or-cmp-map-importer-service-images"
    }
    MapIntersectionExporter = {
      version = "2.1.1"
      image   = "558662781408.dkr.ecr.ap-southeast-2.amazonaws.com/or-cmp-map-intersection-exporter-service-images"
    }
    MapExporter = {
      version = "2.0.7"
      image   = "558662781408.dkr.ecr.ap-southeast-2.amazonaws.com/or-cmp-map-exporter-service-images"
    }
    MapMatcher = {
      version = "2.0.39"
      image   = "558662781408.dkr.ecr.ap-southeast-2.amazonaws.com/or-cmp-map-matcher-service-images"
    }
    MapEditor = {
      version = "2.0.6"
      image   = "558662781408.dkr.ecr.ap-southeast-2.amazonaws.com/or-cmp-map-editor-service-images"
    }
  }
}
...
locals {
  ...
  # eks
  eks_vpc_subnet_ids                 = ["subnet-0080f582a5b583b55", "subnet-0b44d2e4ac13be1b8", "subnet-01f07aa054dbebf6e"]
  eks_cluster_vpc_security_group_ids = ["sg-0600bfa7afc00befc"]
}
