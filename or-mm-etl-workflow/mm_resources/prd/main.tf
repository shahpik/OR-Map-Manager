terraform {
  backend "s3" {
    encrypt        = true
    bucket         = "ddau-tfstate-or-client-dot-prd"
    dynamodb_table = "ddau-tfstate-or-client-dot-prd-lock"
    region         = "ap-southeast-2"
    key            = "step_function_resources/prd/terraform.tfstate"
  }
...
module "mm_etl_workflow" {
  ...
  sfn_role_arn             = "arn:aws:iam::222150071105:role/MM-StepFunction-Role"
