terraform {
  backend "s3" {
    encrypt        = true
    bucket         = "ddau-tfstate-or-client-dot-ppr"
    dynamodb_table = "ddau-tfstate-or-client-dot-ppr-lock"
    region         = "ap-southeast-2"
    key            = "step_function_resources/ppr/terraform.tfstate"
  }
...
module "mm_etl_workflow" {
  ...
  sfn_role_arn             = "arn:aws:iam::388223041415:role/MM-StepFunction-Role"
