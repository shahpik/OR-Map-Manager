...
function basic_osm_graph_stub(weight_type=:distance, graph_type=:static)
    ...
    g = OSMGraph{U,T,W}(nodes=nodes, way=ways, restrictions=restrictions)
...
"""
    basic_osm_graph_stub2(weight_type=:distance, graph_type=:static)
    
Slightly expanded version of the original stub, for more edge case testing
The diagram is approximately geospatially correct.
```ascii
                   1001─┐
                     │  └─┐100km/h, way=2002, dual carriageway
    ...
    50km/h, way=2001 │      │     └─┐ 
                     │      │       └─┐
                   1003    1007──────1008   (1008 to 1007 is way 2004, 50km/h and one way)
                     │      │         │   40km/h, way=2006 one way
    50km/h, way=2001 │    ┌─┘        1009 
                     │  ┌─┘100km/h, way=2002, dual carriageway
                   1004─┘
                     │
    50km/h, way=2003 │
...
```
"""
function basic_osm_graph_stub2(weight_type=:distance, graph_type=:static)
    # Nodes
    lats = [-38.0751637, -38.0752637, -38.0753637, -38.0754637, -38.0755637, -38.0752637, -38.0753637, -38.0753637,  -38.0766637]
    lons = [145.3326838, 145.3326838, 145.3326838, 145.3326838, 145.3326838, 145.3327838, 145.3327838, 145.3328838,  145.3328838]
    node_ids = [1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009]
    nodes = Dict(id => Node(id, GeoLocation(lat, lon), Dict{String, Any}()) for (lat, lon, id) in zip(lats, lons, node_ids))

    # Ways
    way_ids = [2001, 2002, 2003, 2004, 2005, 2006]
    way_nodes = [
        [1001, 1002, 1003, 1004],
        [1001, 1006, 1007, 1004],
        [1004, 1005],
    ...
    tag_dicts = [
        ...
        Dict{String, Any}("oneway" => false, "reverseway" => false, "maxspeed" => Int16(50),  "lanes" => Int8(2)),
        Dict{String, Any}("oneway" => true,  "reverseway" => false, "maxspeed" => Int16(50),  "lanes" => Int8(1)),
        Dict{String, Any}("oneway" => false, "reverseway" => true, "maxspeed" => Int16(50),  "lanes" => Int8(2)),
        Dict{String, Any}("oneway" => true,  "reverseway" => false, "maxspeed" => Int16(40),  "lanes" => Int8(1)),
    ]
    ways = Dict(way_id => Way(way_id, nodes, tag_dict) for (way_id, nodes, tag_dict) in zip(way_ids, way_nodes, tag_dicts))
