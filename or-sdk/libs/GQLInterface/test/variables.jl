@testset "get_variables_str" begin
    ...
    @test GQLInterface.get_variables_str(client, args, arg_names, "Query") == "\$fieldName1: Int,"
    ...
    @test GQLInterface.get_variables_str(client, args, arg_names, "Query") == "\$subfieldName1: Int,"
    ...
    @test GQLInterface.get_variables_str(client, args, arg_names, "Query") == "\$subfieldName1: Int,\$subfieldName2: Int,"
end
...
@testset "get_query_variables" begin
    ...
    args = Dict("fieldName" => 1)
    arg_names = Dict("fieldName" => "fieldName1")
    variables = GQLInterface.get_query_variables(args, arg_names)
    ...
    _, arg_names = GQLInterface.get_query_args_str(args)
    variables = GQLInterface.get_query_variables(args, arg_names)
