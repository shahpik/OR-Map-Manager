...
# Examples
```jldoctest; setup=:(using GQLInterface: get_variables_str, prettify_query, Client)
...
# Examples
```jldoctest; setup=:(using GQLInterface: get_query_args_str, get_query_variables, prettify_query)
