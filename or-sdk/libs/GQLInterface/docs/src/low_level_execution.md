...
HTTP retrying and server runtime execution handling are controlled by keyword arguments in the same was as `query` and `mutate`. See [`GQLInterface.execute`](@ref) for further details.
...
```jldoctest execute; setup=:(using GQLInterface)
julia> # Using URL and query string

julia> GQLInterface.execute("https://countries.trevorblades.com", "query{country(code:\"BR\"){name}}")
...
julia> GQLInterface.execute("https://countries.trevorblades.com", "query(\$code: ID!){country(code:\$code){name}}"; variables)
GQLInterface.GQLResponse{Any}
  data: Dict{String, Any}
          country: Dict{String, Any}
...
julia> GQLInterface.execute("https://countries.trevorblades.com", payload)
GQLInterface.GQLResponse{Any}
  data: Dict{String, Any}
          country: Dict{String, Any}
...
julia> GQLInterface.execute(client, "query{country(code:\"BR\"){name}}")
GQLInterface.GQLResponse{Any}
  data: Dict{String, Any}
          country: Dict{String, Any}

julia> GQLInterface.execute(client, "query(\$code: ID!){country(code:\$code){name}}"; variables)
GQLInterface.GQLResponse{Any}
  data: Dict{String, Any}
          country: Dict{String, Any}

julia> GQLInterface.execute(client, payload)
GQLInterface.GQLResponse{Any}
  data: Dict{String, Any}
          country: Dict{String, Any}
```