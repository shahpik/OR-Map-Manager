...
Contents:
- [JuliaAppTemplate](#juliaapptemplate)
...
- `JuliaAppTemplate.jl` is the top level file for the microservice
...
individual modules which are loaded into `JuliaAppTemplate` by using, for example
