# JedisCluster.jl
A lightweight Redis Cluster client, implemented in Julia.

## Key Features
Links to detailed interfaces and documentation:
- Basic **[command execution](https://captchanjack.github.io/JedisCluster.jl/commands/)**
- Executing commands with a **[global client](https://captchanjack.github.io/JedisCluster.jl/client/)** instance
- **[Pipelining](https://captchanjack.github.io/JedisCluster.jl/pipeline/)**
- **[Transactions](https://captchanjack.github.io/JedisCluster.jl/commands/#JedisCluster.multi)**
- **[Pub/Sub](https://captchanjack.github.io/JedisCluster.jl/pubsub/)**
- **[Redis locks](https://captchanjack.github.io/JedisCluster.jl/lock/)**
- Support for secured Redis connection (**[SSL/TLS](https://captchanjack.github.io/JedisCluster.jl/client/#JedisCluster.get_ssl_config/)**)

## Usage
Establishing a basic **[client](https://captchanjack.github.io/JedisCluster.jl/client/)** connection:
```
client = set_client_instance(host="localhost", port=6379)
```

Establishing a **[secured client](https://captchanjack.github.io/JedisCluster.jl/client/#JedisCluster.get_ssl_config/)** (SSL/TLS) connection:
```
ssl_config = get_ssl_config(ssl_certfile="redis.crt", ssl_keyfile="redis.key", ssl_ca_certs="ca.crt")
client = set_client_instance(ssl_config=ssl_config)
```
...
Executing **[commands](https://captchanjack.github.io/JedisCluster.jl/commands/)**:
```
...
Using **[pipelining](https://captchanjack.github.io/JedisCluster.jl/pipeline/)** to speed up queries:
```
# Normal
pipe = Pipeline()
...
Executing a group of commands atomically with **[MULTI/EXEC transactions](https://captchanjack.github.io/JedisCluster.jl/commands/#JedisCluster.multi)**:
```
# Normal
multi()
set("key", "value")
...
Using Redis **[Pub/Sub](https://captchanjack.github.io/JedisCluster.jl/pubsub/)** (interfaces for `subscribe` and `psubscribe` are the same):
```
# Set up channels, publisher and subscriber clients
channels = ["first", "second"]
publisher = set_client_instance()
subscriber = set_client_instance()
...
Using **[redis locks](https://captchanjack.github.io/JedisCluster.jl/lock/)** for performing atomic operations:
```
